...
//---------------------------------------------------------------------
void l2norm_HTA(int pid, double sum[5], HTA *rsd_HTA, HTA *sum_HTA)
{
    //---------------------------------------------------------------------
    // local variables
    //---------------------------------------------------------------------
    ...
    HTA_map_h1s1(HTA_LEAF_LEVEL(sum_HTA), H1S1_INIT, sum_HTA, &initval);
    ...
    HTA_flatten(sum_temp, NULL, NULL, r3);
