...
test_baseval={
                ...
                'time_ocr-run-kernel-Stencil2DChandra-x86-remote-regression':4.917,
                'scale_ocr-run-kernel-Stencil2DChandra-x86-remote-scaling':1,
                ...
                'time_ocr-run-kernel-comdsdsc2-x86-remote-regression':0.94,
                'scale_ocr-run-kernel-comdsdsc2-x86-remote-scaling':1,
                ...
                'time_ocr-run-kernel-rsbench-x86-remote-regression':2.30,
                'scale_ocr-run-kernel-rsbench-x86-remote-scaling':1,
