...
test_baseval={
                ...
                'time_ocr-run-kernel-p2p-x86-remote-regression':0.63,
                'time_ocr-run-kernel-globalsum-x86-remote-regression':0.42,
                'time_ocr-run-kernel-triangle-x86-remote-regression':145,
