...
{
   char potDir[10/*1024*/];  //!< the directory where EAM potentials reside
   char potName[10]; //!< the name of the potential
   char potType[10]; //!< the type of the potential (funcfl or setfl)
