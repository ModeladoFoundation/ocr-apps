...
typedef struct LinkCellSt
{
   ...
   ocrDBK_t DBK_nAtoms;
   int* nAtoms;         //!< total number of atoms in each box //TODO
} LinkCell;

void initLinkCells(LinkCell* ll, const struct DomainSt* domain, real_t cutoff);
...
ocrGuid_t updateLinkCellsEdt( EDT_ARGS );
