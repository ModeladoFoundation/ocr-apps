...
void initAtomHaloExchange(HaloExchange* hh, struct DomainSt* domain, struct LinkCellSt* boxes);

/// Create a HaloExchange for force data.
void initForceHaloExchange(HaloExchange* hh, struct DomainSt* domain, struct LinkCellSt* boxes);
