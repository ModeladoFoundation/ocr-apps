...
typedef struct
{
  ...
  real3_t max;
  u32 max_occupancy;
  ocrGuid_t nbr_atomDataGuids[27]; //TODO: DO I need 26 or 27?
...
typedef struct
{
    //localDataSt_t localDataSt;
    ocrGuid_t DBK_linkCell;
    ocrGuid_t DBK_atomData;
...
typedef struct
{
  ...
  ocrGuid_t EVT_MAP_position, EVT_MAP_redistribute;
  ocrGuid_t EVT_MAP_reduction;

  ocrGuid_t OEVT_finalize;
