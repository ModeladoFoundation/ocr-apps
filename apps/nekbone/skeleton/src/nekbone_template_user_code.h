 ...
 * =====================================================================================
 *
 *       Filename:  nekbone_template_user_code.h
 *
 *    Description:
 *
 *        Version:  1.0
 *        Created:  2013 Sept 11
 *       Revision:  none
 *       Compiler:  what works
 *
 *         Author:  dvillen
...
//#ifdef USE_THE_SIMULATOR
//#include "template_user_code.h"
//#include "tmpl.h"
//#else
//class TemplateUserCode {};
//#endif
...
//#ifdef USE_THE_SIMULATOR
//    NekCGsim( TemplateStateMachineEntry* sm_entry
//            , TemplateRequestHandleManager* trhm
...
private:
    ...
    struct NeighborLoad
    {
        ...
        unsigned long ownedConnectDOF; //=The count of owned connected DOF.
                                       //=A connected DOF is a DOF on the gloabl grid
                                       // for the entire geometry, i.e. see NekCGsim::globPartP
                                       //=A DOF is owned if by the current rank
                                       // the current rank number is bigger than this-->rid.
                                       // Ownership is a way to avoid multi[le counting
                                       // for DOF shared amoung many ranks.
    };
