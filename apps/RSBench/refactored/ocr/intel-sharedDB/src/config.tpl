...
[SocketGlobal]
   ...
   xe_img_fname  = $(WORKLOAD_INSTALL)/RSBench        # file to load
   bin_img_fname = $(WORKLOAD_INSTALL)/RSBench.blob  # file to load
...
[BlockGlobal]
   ...
   logfilebase   = RSBench.log                  # what is the BASE path+filename to write log files to, default is STDERR
