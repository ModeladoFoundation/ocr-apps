...
void get_materials(Inputs input, int* PTR_numNucs_mat, ocrGuid_t* PTR_nuclideIDs_DBguids_mat, ocrGuid_t* PTR_nuclideConcs_DBguids_mat)
{
    load_num_nucs(input, PTR_numNucs_mat);
    load_mats(input, PTR_numNucs_mat, PTR_nuclideIDs_DBguids_mat);
    load_concs(PTR_numNucs_mat, PTR_nuclideConcs_DBguids_mat);
