...
void Model::ResetTimestepScheme( TimestepScheme * pTimestepScheme ) {

    m_pTimestepScheme = pTimestepScheme;

}

void Model::ResetHorizontalDynamics( HorizontalDynamics * pHorizontalDynamics ) {

    m_pHorizontalDynamics = pHorizontalDynamics;

}

void Model::ResetVerticalDynamics( VerticalDynamics * pVerticalDynamics ) {

    m_pVerticalDynamics = pVerticalDynamics;

}

void Model::ResetGrid( Grid * pGrid ) {
