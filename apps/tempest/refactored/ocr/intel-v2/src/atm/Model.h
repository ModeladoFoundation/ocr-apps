...
public:
    ...
    /// <summary>
    ///     Attach the timestep scheme (for OCR), to be used in the event
    ///     of the timestep scheme needing to be reattached.
    /// </summary>
    void ResetTimestepScheme( TimestepScheme * pTimestepScheme );

    /// <summary>
    ///     Attach the Horizontal Dynamics (for OCR), to be used in the event
    ///     of the Horizontal Dynamics needing to be reattached.
    /// </summary>
    void ResetHorizontalDynamics( HorizontalDynamics * pHorizontalDynamics );

    /// <summary>
    ///     Attach the Vertical Dynamics(for OCR), to be used in the event
    ///     of the Vertical Dynamics needing to be reattached.
    /// </summary>
    void ResetVerticalDynamics( VerticalDynamics * pVerticalDynamics );

    /// <summary>
    ///     Reset the Grid (for OCR), to be used in the event
    ///     of the Grid needing to be reattached.
    /// </summary>
    void ResetGrid( Grid * pGrid );
