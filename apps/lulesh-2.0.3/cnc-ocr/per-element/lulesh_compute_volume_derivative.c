...
void compute_volume_derivative(cncTag_t iteration, cncTag_t element_id, delta_timeItem delta_time_in, neighbor_positionItem *neighbor_position, neighbor_velocityItem *neighbor_velocity, luleshCtx *ctx) {
	...
	double *volume_derivative_out;
	cncHandle_t volume_derivative_outHandle = cncCreateItem_volume_derivative(&volume_derivative_out);
	*volume_derivative_out = volume_derivative;
	cncPut_volume_derivative(volume_derivative_outHandle, iteration, element_id, ctx);
