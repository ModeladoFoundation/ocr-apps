...
static inline int globalRankFromCoords_Cart1D( int id_x, int NR_X );
...
{
    PDinit1dEdt_paramv_t* PTR_PDinitEdt_paramv = (PDinit1dEdt_paramv_t*) paramv;
    ...
    globalCoordsFromRank_Cart3D( PD_id, pdGridDims[0], &pd_x );
...
void forkSpmdEdts_staticScheduler_Cart1D( ocrGuid_t (*initEdt)(u32, u64*, u32, ocrEdtDep_t*), u64* edtGridDims, ocrGuid_t* spmdDepv )
{
    ...
    PDinit1dEdt_paramv_t PDinitEdt_paramv;
    ocrEdtTemplateCreate( &PDinitTML, PDinitEdt, sizeof(PDinit1dEdt_paramv_t)/sizeof(u64), 2 );
