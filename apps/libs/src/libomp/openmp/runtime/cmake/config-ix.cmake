...
# compiler flags
 ...
 set(LIBOMP_HAVE_FNO_EXCEPTIONS_FLAG TRUE)
 set(LIBOMP_HAVE_X_CPP_FLAG TRUE)
 set(LIBOMP_HAVE_WERROR_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_UNUSED_FUNCTION_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_UNUSED_LOCAL_TYPEDEF_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_UNUSED_VALUE_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_UNUSED_VARIABLE_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_SWITCH_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_COVERED_SWITCH_DEFAULT_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_DEPRECATED_REGISTER_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_SIGN_COMPARE_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_GNU_ANONYMOUS_STRUCT_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_UNKNOWN_PRAGMAS_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_MISSING_FIELD_INITIALIZERS_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_MISSING_BRACES_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_COMMENT_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_SELF_ASSIGN_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_VLA_EXTENSION_FLAG TRUE)
 set(LIBOMP_HAVE_WNO_FORMAT_PEDANTIC_FLAG FALSE)
 set(LIBOMP_HAVE_MSSE2_FLAG FALSE)
 set(LIBOMP_HAVE_FTLS_MODEL_FLAG TRUE)

# architecture flags
 set(LIBOMP_HAVE_MMIC_FLAG FALSE)
 set(LIBOMP_HAVE_M32_FLAG TRUE)

# linker flags
 set(LIBOMP_HAVE_X_FLAG TRUE)
 set(LIBOMP_HAVE_WARN_SHARED_TEXTREL_FLAG TRUE)
 set(LIBOMP_HAVE_AS_NEEDED_FLAG TRUE)
 set(LIBOMP_HAVE_VERSION_SCRIPT_FLAG TRUE)
 set(LIBOMP_HAVE_STATIC_LIBGCC_FLAG FALSE)
 set(LIBOMP_HAVE_Z_NOEXECSTACK_FLAG TRUE)
 set(LIBOMP_HAVE_FINI_FLAG TRUE)
