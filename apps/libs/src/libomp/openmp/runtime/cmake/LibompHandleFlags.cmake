...
function(libomp_get_c_and_cxxflags_common flags)
  ...
  elseif(${MIC})
	...
	elseif(${XSTG})
		libomp_append(flags_local ${COMPILE_FLAGS})
		libomp_append(flags_local -D_LIBCPP_HAS_NO_LONG_LONG)
        if(${_POSIX_THREADS})
          libomp_append(flags_local -D_POSIX_THREADS)
        endif()
  endif()
...
function(libomp_get_asmflags asmflags)
  ...
  elseif(${MIC})
	...
	elseif(${XSTG})
    libomp_append(asmflags_local -DKMP_ARCH_XSTG=1)
  endif()
