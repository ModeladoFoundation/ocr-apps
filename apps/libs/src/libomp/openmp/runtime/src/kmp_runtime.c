...
#endif /* (KMP_OS_LINUX || KMP_OS_TGR) && ( KMP_ARCH_X86 || KMP_ARCH_X86_64 || KMP_ARCH_ARM || KMP_ARCH_AARCH64 || KMP_ARCH_XSTG) */
...
#if KMP_OS_LINUX && KMP_AFFINITY_SUPPORTED // TGR TODO KMP_OS_TGR
...
// we don't support DYNAMIC_LIB for KMP_OS_TGR
...
#if KMP_ARCH_X86_64 && (KMP_OS_LINUX || KMP_OS_WINDOWS) // TGR TODO KMP_OS_TGR
        ...
        kmp_critical_name *lck )
{
    ...
    if( team_size == 1 ) {
	    ...
	    int teamsize_cutoff = 4;
            ...
            #endif // KMP_OS_LINUX || KMP_OS_FREEBSD || KMP_OS_NETBSD || KMP_OS_WINDOWS || KMP_OS_DARWIN || KMP_OS_TGR

        #elif KMP_ARCH_X86 || KMP_ARCH_ARM || KMP_ARCH_AARCH || KMP_ARCH_XSTG

            #if KMP_OS_LINUX || KMP_OS_WINDOWS || KMP_OS_TGR
