...
#else
#define __libc_lock_init(NAME) \
  (__libc_maybe_call2 (pthread_mutex_init, ((pthread_mutex_t*)&(NAME), NULL), 0))
#endif
...
#define __libc_lock_fini(NAME) \
  (__libc_maybe_call2 (pthread_mutex_destroy, ((pthread_mutex_t*)&(NAME)), 0));
...
#define __libc_lock_lock(NAME) \
  (__libc_maybe_call2 (pthread_mutex_lock, ((pthread_mutex_t*)&(NAME)), 0));
...
#define __libc_lock_trylock(NAME) \
  (__libc_maybe_call2 (pthread_mutex_trylock, ((pthread_mutex_t*)&(NAME)), 0))
...
#define __libc_lock_unlock(NAME) \
  (__libc_maybe_call2 (pthread_mutex_unlock, ((pthread_mutex_t*)&(NAME)), 0));
