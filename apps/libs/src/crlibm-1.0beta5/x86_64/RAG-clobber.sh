...
acos-td.c asin-td.c exp-itanium.c log2_accurate.c \
log_accurate.c log-de2.c log_fast.c \
...
acos-td.h asin-td.h atan-pentium.h interval.h \
log2_accurate.h log_accurate.h log-de2.h log_fast.h \
...
compile test-driver prepare CMakeLists.txt crlibm.spec README.DEV
echo Remove all subdirectories and their contents.
