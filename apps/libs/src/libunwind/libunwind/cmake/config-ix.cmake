...
if(LIBUNWIND_TARGET STREQUAL "XSTG" )
 message(STATUS "Configuring for XSTG")
 set(LIBUNWIND_HAS_STDCXX11_FLAG TRUE)
 set(LIBUNWIND_HAS_STDCXX1Y_FLAG TRUE)
 set(LIBUNWIND_HAS_FPIC_FLAG FALSE)
 set(LIBUNWIND_HAS_FSTRICT_ALIASING_FLAG FALSE)
 set(LIBUNWIND_HAS_FNO_OMIT_FRAME_POINTER_FLAG TRUE)
 set(LIBUNWIND_HAS_FNODEFAULTLIBS_FLAG TRUE)
 set(LIBUNWIND_HAS_FNOSTDINCXX_FLAG TRUE)
 set(LIBUNWIND_HAS_WALL_FLAG TRUE)
 set(LIBUNWIND_HAS_W_FLAG TRUE)
 set(LIBUNWIND_HAS_WNO_UNUSED_PARAMETER_FLAG TRUE)
 set(LIBUNWIND_HAS_WWRITE_STRINGS_FLAG TRUE)
 set(LIBUNWIND_HAS_PEDANTIC_FLAG TRUE)
 set(LIBUNWIND_HAS_WERROR_FLAG TRUE)
 set(LIBUNWIND_HAS_WNO_ERROR_FLAG TRUE)
 set(LIBUNWIND_HAS_FNO_EXCEPTIONS_FLAG TRUE)
 set(LIBUNWIND_HAS_FNO_RTTI_FLAG TRUE)
 set(LIBUNWIND_HAS_GLINE_TABLES_ONLY_FLAG TRUE)
 set(LIBUNWIND_HAS_WX_FLAG FALSE)
 set(LIBUNWIND_HAS_NO_WX_FLAG FALSE)
 set(LIBUNWIND_HAS_EHSC_FLAG FALSE)
 set(LIBUNWIND_HAS_NO_EHS_FLAG FALSE)
 set(LIBUNWIND_HAS_NO_EHA_FLAG FALSE)
 set(LIBUNWIND_HAS_NO_GR_FLAG FALSE)
 set(LIBUNWIND_HAS_C_LIB TRUE)

elseif(LIBUNWIND_TARGET STREQUAL "x86_64" )
