...
ocrPtr_t  __template_uts_main = { .offset = (size_t)uts_main, .guid = NULL_GUID };
...
ocrPtr_t  __template_uts_parseParams = { .offset = (size_t)uts_parseParams, .guid = NULL_GUID };
...
ocrPtr_t  __template_uts_printParams = { .offset = (size_t)uts_printParams, .guid = NULL_GUID };
...
ocrPtr_t  __template_uts_initTreeRoot = { .offset = (size_t)uts_initTreeRoot, .guid = NULL_GUID };
...
ocrPtr_t  __template_uts_TreeSearch = { .offset = (size_t)uts_TreeSearch, .guid = NULL_GUID };
