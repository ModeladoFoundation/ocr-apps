...
#else
	return "MPI Workmanager non-blocking"; /* RAG -- added text for non-blocking */
#endif
}
...
#if 1
/* RAG -- Think this fixes a bug in origonal code */
		rls_buff = work;

		MPI_Isend(rls_buff, s->work_size*s->chunk_size, MPI_BYTE, work_queue_id,
