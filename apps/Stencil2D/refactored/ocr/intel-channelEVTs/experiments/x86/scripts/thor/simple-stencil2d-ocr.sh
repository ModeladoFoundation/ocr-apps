...
case $scale in
	...
	echo " ${gsize} x ${gsize}           ${ntiles[$i]} "
	echo "$MYOCR ${EXE} ${gsize} ${ntiles[$i]} ${nitr}"

	$MYOCR ${EXE} ${gsize} ${ntiles[$i]} ${nitr}
	...
	echo "$MYOCR ${EXE}  ${gsize[$i]} ${ntiles[$i]} ${nitr}"

	$MYOCR ${EXE}  ${gsize[$i]} ${ntiles[$i]} ${nitr}
