...
#
# Idleness caracterisation metric experiment
#
...
CPGNBASE=${CPGNBASE-"idleness-metrics-stencil2d-detailed"}
# OCR variants base install folder name
OCR_BASE=${OCR_BASE-"ocr_install_mpicc_"}
# OCR variants to sweep over
OCR_VARIANT_LIST=${OCR_VARIANT_LIST-"metrics-worker-detailed-edt"}
