...
int g500main (int argc, char **argv)
{
...
void main (int argc, char **argv) {
  ...
  // hack to make sure we don't mis-run things on the cluster machines
  if (omp_get_num_threads()>8) {
    fprintf(stderr, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
    fprintf(stderr, "More than 8 XEs worth of threads?!?\n");
    fprintf(stderr, "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!\n");
  }
