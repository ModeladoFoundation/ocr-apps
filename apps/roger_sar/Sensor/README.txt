...
To build and run H-C, AFL, and SIM versions of SAR for small problem from Sensor directory do:

	make small

To build and run H-C and AFL versions of SAR for large problem from Sensor directory do:
	make large
