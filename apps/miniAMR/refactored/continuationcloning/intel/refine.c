...
#define i                 (lcl->i)
#define j                 (lcl->j)
//#define n                 (lcl->n)       // Name overloaded.  Use qualified name.
#define in                (lcl->in)
#define min_b             (lcl->min_b)
#define max_b             (lcl->max_b)
#define sum_b             (lcl->sum_b)
#define num_refine_step   (lcl->num_refine_step)
#define num_split         (lcl->num_split)
#define nm_r              (lcl->nm_r)
#define nm_c              (lcl->nm_c)
#define nm_t              (lcl->nm_t)
#define ratio             (lcl->ratio)
#define tp                (lcl->tp)
#define tm                (lcl->tm)
#define tu                (lcl->tu)
#define tp1               (lcl->tp1)
...
#define bp                (lcl->pointers.bp)
   ...
   SUSPENDABLE_FUNCTION_PROLOGUE(Frame__refine_t)
   TRACE
...
#define pp                (lcl->pointers.pp)
   ...
   SUSPENDABLE_FUNCTION_PROLOGUE(Frame__refine_level_t)
   TRACE
...
#define pp                (lcl->pointers.pp)
   ...
   SUSPENDABLE_FUNCTION_PROLOGUE(Frame__redistribute_blocks_t)
   TRACE
