 ...
 * Optimization Raise[-liftnone] (473ms)
 * Optimization PolyhedralMapperNew[logfile=mapper.log] (4124ms)
 * Optimization Lower (292ms)
...
struct __anon1_18_2;
union __args_cheby_mappable_kernel18_21_2;
union ocrGuidUnion_t;
struct ocrEdtDepStruct_t;
struct __anon3_18_2;
union __args_cheby_mappable_kernel18_2_main_4;
union ocrGuidUnion_t;
struct va_list_t;
struct __anon1_18_2 {
   double const* chebyshev_c1;
   double const* chebyshev_c2;
   double (* x_np1_1)[18][18];
   double (* x_np1_0)[18][18];
...
union __args_cheby_mappable_kernel18_2_main_4 {
   struct __anon3_18_2 data;
   double padding[13];
};
/*
 * Forward declarations of functions
 */
void cheby_mappable_kernel18_2(int H2INV, int s, int ss, int ghosts, int
   ghostsToOperateOn, int dim, double const* chebyshev_c1, double const*
   chebyshev_c2, double (* x_np1_0)[18][18], double (* x_np1_1)[18][18], double
   const (* rhs)[18][18], double const (* alpha)[18][18], double const (*
   beta_i)[18][18], double const (* beta_j)[18][18], double const (* beta_k)[18
   ][18], double const (* Dinv)[18][18], double const (* valid)[18][18]);
static ocrGuid_t cheby_mappable_kernel18_21(unsigned int paramc, unsigned long*
    paramv, unsigned int depc, ocrEdtDep_t* depv);
void* rocrArgs(ocrEdtDep_t*);
ocrGuid_t rocrAlloc(void** x0, unsigned long k);
static ocrGuid_t cheby_mappable_kernel18_2_main(unsigned int paramc,
...
#endif
#ifdef GPU_TARGET
    #define __mins18_2_32(x,y) \
 min((int)(x),(int)(y))
#else
static RSTREAM_INLINE int __mins18_2_32(int x, int y) {
   return x < y ? x : y;
}
#endif
/*
...
{
   union __args_cheby_mappable_kernel18_2_main_4* allArgs;
   rocrDeclareType(cheby_mappable_kernel18_2_main, 1, (unsigned int)1, 1, (
      unsigned long (*)(va_list))((void*)0l));
   rocrDeclareType(cheby_mappable_kernel18_21, 0, (unsigned int)(2 *
   ...
   if (2 * ghostsToOperateOn + dim >= 1) {
      ocrGuid_t _t1;
      union __args_cheby_mappable_kernel18_2_main_4* _t2;
...
{ rocrParseInputArgs(paramc, paramv, depc, depv);
   union __args_cheby_mappable_kernel18_21_2 cheby_mappable_kernel18_21_args;
   double const* chebyshev_c1;
   double const* chebyshev_c2;
   double (* x_np1_1)[18][18];
   double (* x_np1_0)[18][18];
   ...
   int _t1;
   int i;
   for (cheby_mappable_kernel18_21_args = *(union
           __args_cheby_mappable_kernel18_21_2*)rocrArgs(depv),
        IT2 = cheby_mappable_kernel18_21_args.data.IT2,
        IT1 = cheby_mappable_kernel18_21_args.data.IT1,
        IT0 = cheby_mappable_kernel18_21_args.data.IT0,
        dim = cheby_mappable_kernel18_21_args.data.dim,
        ghostsToOperateOn = cheby_mappable_kernel18_21_args.data.
           ghostsToOperateOn,
        _t1 = (__mins18_2_32(1, 2 * ghostsToOperateOn + dim + -2 * IT0 + -1)),
        ss = cheby_mappable_kernel18_21_args.data.ss,
        H2INV = cheby_mappable_kernel18_21_args.data.H2INV,
        rhs = cheby_mappable_kernel18_21_args.data.rhs,
        beta_k = cheby_mappable_kernel18_21_args.data.beta_k,
        beta_j = cheby_mappable_kernel18_21_args.data.beta_j,
        valid = cheby_mappable_kernel18_21_args.data.valid,
        beta_i = cheby_mappable_kernel18_21_args.data.beta_i,
        alpha = cheby_mappable_kernel18_21_args.data.alpha,
        x_np1_0 = cheby_mappable_kernel18_21_args.data.x_np1_0,
        x_np1_1 = cheby_mappable_kernel18_21_args.data.x_np1_1,
        chebyshev_c2 = cheby_mappable_kernel18_21_args.data.chebyshev_c2,
        chebyshev_c1 = cheby_mappable_kernel18_21_args.data.chebyshev_c1,
        i = 0;
        i <= _t1; i++) {
      int _t2;
      int j;
      for (_t2 = (__mins18_2_32(31, 2 * ghostsToOperateOn + dim + -32 * IT1 + -1)),
               j = 0; j <= _t2; j++) {
         int _t3;
         int k;
         for (_t3 = (__mins18_2_32(511, 2 * ghostsToOperateOn + dim + -512 * IT2 +
                 -1)), k = 0; k <= _t3; k++) {
            double _t4;
            double _t5;
            double _t6;
...
{ rocrParseInputArgs(paramc, paramv, depc, depv);
   union __args_cheby_mappable_kernel18_2_main_4
      cheby_mappable_kernel18_2_main_args;
   union __args_cheby_mappable_kernel18_21_2* allArgs;
   double const* chebyshev_c1;
   double const* chebyshev_c2;
   double (* x_np1_1)[18][18];
   double (* x_np1_0)[18][18];
   ...
   int _t1;
   int i;
   for (cheby_mappable_kernel18_2_main_args = *(union
           __args_cheby_mappable_kernel18_2_main_4*)rocrArgs(depv),
        dim = cheby_mappable_kernel18_2_main_args.data.dim,
        ghostsToOperateOn = cheby_mappable_kernel18_2_main_args.data.
           ghostsToOperateOn,
        _t1 = 2 * ghostsToOperateOn + dim + -1 >> 1,
        ghosts = cheby_mappable_kernel18_2_main_args.data.ghosts,
        ss = cheby_mappable_kernel18_2_main_args.data.ss,
        s = cheby_mappable_kernel18_2_main_args.data.s,
        H2INV = cheby_mappable_kernel18_2_main_args.data.H2INV,
        rhs = cheby_mappable_kernel18_2_main_args.data.rhs,
        beta_k = cheby_mappable_kernel18_2_main_args.data.beta_k,
        beta_j = cheby_mappable_kernel18_2_main_args.data.beta_j,
        valid = cheby_mappable_kernel18_2_main_args.data.valid,
        beta_i = cheby_mappable_kernel18_2_main_args.data.beta_i,
        alpha = cheby_mappable_kernel18_2_main_args.data.alpha,
        x_np1_0 = cheby_mappable_kernel18_2_main_args.data.x_np1_0,
        x_np1_1 = cheby_mappable_kernel18_2_main_args.data.x_np1_1,
        chebyshev_c2 = cheby_mappable_kernel18_2_main_args.data.chebyshev_c2,
        chebyshev_c1 = cheby_mappable_kernel18_2_main_args.data.chebyshev_c1,
        i = 0;
        i <= _t1; i++) {
      int _t2;
      int j;
      for (_t2 = 2 * ghostsToOperateOn + dim + -1 >> 5, j = 0; j <= _t2; j++) {
         ...
         for (_t3 = 2 * ghostsToOperateOn + dim + -1 >> 9, k = 0; k <= _t3; k++
            ...
            ocrGuid_t _t4;
            union __args_cheby_mappable_kernel18_21_2* _t5;
